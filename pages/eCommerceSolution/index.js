...
const eCommerce = () => {
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2">
      <div className='mt-16'>
        <h1 className='font-bold text-8xl'>E-commerce </h1>
        <h2 className='font-bold text-6xl text-secondary'>SOLUTIONS</h2>
      ...
      <div>
        <img src="eCommerse.png" alt="web" className='mx-auto h-[500px]' />
      </div>
    </div>
