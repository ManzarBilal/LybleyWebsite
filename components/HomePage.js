                ...
                <div className=" grid md:grid-cols-2 sm:grid-cols-1    h-full">
                    <div className="h-full flex justify-center items-center p-4  ">
                        <div className="container grid grid-cols-1 gap-2">
                            ...
                            <div className='animatedLeft mt-3 text-white text-xl'>Empowering businesses with top IT solutions and unparalleled marketing strategies for digital success.</div>
